 ...
 */
	...
	$category_slug 	= empty( $permalinks['category_base'] ) ? _x( 'product-category', 'slug', 'theretailer' ) : $permalinks['category_base'];
    ...
    <div class="product_main_infos">
        ...
        <div class="gbtr_poduct_details_left_col">
			...
			<?php if ( !$product->is_in_stock() ) : ?>            
            	<div class="out_of_stock_badge_single <?php if (!$product->is_on_sale()) : ?>first_position<?php endif; ?>"><?php _e( 'Out of stock', 'theretailer' ); ?></div>            
			<?php endif; ?>	
            ...
            <div class="product_navigation desktops">
                ...
                <?php
					...
					foreach ($terms as $term) {
						...
						//the term with the longest link should be the one we want
						if(strlen($term_link) > strlen($term_longest_link)){
							$term_longest_link = $term_link;
							$term_name = $term->name;
						}
					}	
					$term_list .= '<a href="'. $term_longest_link . '">' . $term_name . '</a>';
