			...
			<div id="content" class="site-content" role="main">
                ...
                <div class="entry-content page_404">
                    ...
                    <div class="img_404"></div>
						...
						<h3>If you are a Wholesale customer, please <a href="<?php echo esc_url( get_permalink( get_page_by_title( 'Login' ) ) ); ?>" title="Login">Login</a> to access the Wholesale Orders page. </h3>
